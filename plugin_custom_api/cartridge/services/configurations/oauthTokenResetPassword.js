...
function request(service, requestDataContainer) {
    ...
    const scapiUtils = require('*/cartridge/scripts/util/scapi');
    ...
    const organizationAssets = scapiUtils.getOrganizationAssets();
    ...
    const requestConfig = {
        ...
        parameters: {
            ...
            scope: ['SALESFORCE_COMMERCE_API', organizationAssets.tenant ,'sfcc.shopper-customers.login'].join(':')
        },
        headers: {
            Authorization: token,            
